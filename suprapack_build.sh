...
# External SupraVim plugins
git clone https://github.com/nda-cunh/ScrollBar.git --depth 1
...
git clone https://github.com/nda-cunh/dvd.vim --depth 1
git clone https://github.com/nda-cunh/SupraIndent --depth 1
# External plugins
