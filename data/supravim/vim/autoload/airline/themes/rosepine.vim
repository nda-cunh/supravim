...
final base = '#191724'
final surface = '#1f1d2e'
final overlay = '#26233a'
final muted = '#6e6a86'
final subtle = '#908caa'
final text = '#e0def4'
final love = '#eb6f92'
...
final foam = '#9ccfd8'
final iris = '#c4a7e7'
final highlight_low = '#21202e'
final highlight_med = '#403d52'
final highlight_high = '#524f67'
...
# --- Airline ---
g:airline#themes#rosepine#palette = {}
