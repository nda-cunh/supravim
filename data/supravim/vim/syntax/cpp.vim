...
highlight link cppTemplateType Type
syntax match cClassName "\<\u\l\w*\>"
highlight link cClassName Type

syntax match cppScope "\<\h\w*\ze::"
# Namspace do not exist on vim9
