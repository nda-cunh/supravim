...
if (has('termguicolors') && &termguicolors) || has('gui_running')
	g:terminal_ansi_colors = ['#393552', '#eb6f92', '#3e8fb0', '#f6c177', '#9ccfd8', '#c4a7e7', '#ea9a97', '#e0def4', '#908caa', '#eb6f92', '#3e8fb0', '#f6c177', '#9ccfd8', '#c4a7e7', '#ea9a97', '#e0def4']
endif
...
hi markdownH3 guifg=#ea9a97 guibg=NONE gui=NONE cterm=NONE
...
hi VimwikiHeader3 guifg=#ea9a97 guibg=NONE gui=NONE cterm=NONE
hi VimwikiHeader4 guifg=#f6c177 guibg=NONE gui=NONE cterm=NONE
hi VimwikiHeader5 guifg=#3e8fb0 guibg=NONE gui=NONE cterm=NONE
...
if t_Co >= 256
  ...
  hi PmenuMatch guifg=#f6c177 guibg=NONE gui=NONE cterm=NONE
