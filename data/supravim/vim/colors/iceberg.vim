...
if &background == 'light'
  ...
  hi IncSearch cterm=NONE ctermfg=NONE gui=NONE guifg=NONE term=NONE
  ...
  hi SpellBad ctermbg=181 ctermfg=237 gui=NONE guifg=NONE guisp=#cc517a
  hi SpellCap ctermbg=117 ctermfg=237 gui=NONE guifg=NONE guisp=#2d539e
  hi SpellLocal ctermbg=116 ctermfg=237 gui=NONE guifg=NONE guisp=#3f83a6
  hi SpellRare ctermbg=110 ctermfg=237 gui=NONE guifg=NONE guisp=#7759b4
  ...
  hi Underlined cterm=NONE ctermfg=25 gui=NONE guifg=#2d539e term=NONE
  ...
  hi TSURI cterm=NONE ctermfg=31 gui=NONE guifg=#3f83a6 term=NONE
  hi ZenSpace ctermbg=125 guibg=#cc517a
  hi DiagnosticUnderlineInfo cterm=NONE ctermfg=31 gui=NONE guisp=#3f83a6 term=NONE
  hi DiagnosticInfo ctermfg=31 guifg=#3f83a6
  hi DiagnosticSignInfo ctermbg=253 ctermfg=31 guibg=#dcdfe7 guifg=#3f83a6
  hi DiagnosticUnderlineHint cterm=NONE ctermfg=244 gui=NONE guisp=#8389a3 term=NONE
  hi DiagnosticHint ctermfg=244 guifg=#8389a3
  hi DiagnosticSignHint ctermbg=253 ctermfg=244 guibg=#dcdfe7 guifg=#8389a3
  hi DiagnosticUnderlineWarn cterm=NONE ctermfg=130 gui=NONE guisp=#c57339 term=NONE
  hi DiagnosticWarn ctermfg=130 guifg=#c57339
  hi DiagnosticSignWarn ctermbg=253 ctermfg=130 guibg=#dcdfe7 guifg=#c57339
  hi DiagnosticUnderlineError cterm=NONE ctermfg=125 gui=NONE guisp=#cc517a term=NONE
...
g:terminal_ansi_colors = ['#dcdfe7', '#cc517a', '#668e3d', '#c57339', '#2d539e', '#7759b4', '#3f83a6', '#33374c', '#8389a3', '#cc3768', '#598030', '#b6662d', '#22478e', '#6845ad', '#327698', '#262a3f']
  ...
  hi SpellBad ctermbg=95 ctermfg=252 gui=NONE guifg=NONE guisp=#e27878
  hi SpellCap ctermbg=24 ctermfg=252 gui=NONE guifg=NONE guisp=#84a0c6
  hi SpellLocal ctermbg=23 ctermfg=252 gui=NONE guifg=NONE guisp=#89b8c2
  hi SpellRare ctermbg=97 ctermfg=252 gui=NONE guifg=NONE guisp=#a093c7
  ...
  hi Underlined cterm=NONE ctermfg=110 gui=NONE guifg=#84a0c6 term=NONE
  ...
  hi TSURI cterm=NONE ctermfg=109 gui=NONE guifg=#89b8c2 term=NONE
  hi ZenSpace ctermbg=203 guibg=#e27878
  hi DiagnosticUnderlineInfo cterm=NONE ctermfg=109 gui=NONE guisp=#89b8c2 term=NONE
  hi DiagnosticInfo ctermfg=109 guifg=#89b8c2
  hi DiagnosticSignInfo ctermbg=235 ctermfg=109 guibg=#1e2132 guifg=#89b8c2
  hi DiagnosticUnderlineHint cterm=NONE ctermfg=242 gui=NONE guisp=#6b7089 term=NONE
  hi DiagnosticHint ctermfg=242 guifg=#6b7089
  hi DiagnosticSignHint ctermbg=235 ctermfg=242 guibg=#1e2132 guifg=#6b7089
  hi DiagnosticUnderlineWarn cterm=NONE ctermfg=216 gui=NONE guisp=#e2a478 term=NONE
  hi DiagnosticWarn ctermfg=216 guifg=#e2a478
  hi DiagnosticSignWarn ctermbg=235 ctermfg=216 guibg=#1e2132 guifg=#e2a478
  hi DiagnosticUnderlineError cterm=NONE ctermfg=203 gui=NONE guisp=#e27878 term=NONE
