...
hi DraculaTodo guifg=#8BE9FD ctermfg=117 guibg=NONE ctermbg=NONE gui=bold,inverse cterm=bold,inverse guisp=NONE
...
hi MatchParen guifg=#50FA7B ctermfg=84 guibg=NONE ctermbg=NONE gui=underline cterm=underline guisp=NONE
hi Conceal guifg=#8BE9FD ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE guisp=NONE
hi Cursor guifg=#282A36 ctermfg=NONE guibg=#FF79C6 ctermbg=238 gui=NONE cterm=NONE guisp=NONE
