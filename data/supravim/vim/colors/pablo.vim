...
var t_Co: number = str2nr(exists('&t_Co') && !has('gui_running') ? (&t_Co ?? 0) : -1)

if (has('termguicolors') && &termguicolors) || has('gui_running')
	g:terminal_ansi_colors = ['#000000', '#cd0000', '#00cd00', '#cdcd00', '#0000ee', '#cd00cd', '#00cdcd', '#e5e5e5', '#7f7f7f', '#ff0000', '#00ff00', '#ffff00', '#5c5cff', '#ff00ff', '#00ffff', '#ffffff']
endif
...
hi VertSplit guifg=#3d3d3d guibg=#000000 gui=NONE cterm=NONE
...
hi Function guifg=#ffaf00 guibg=NONE gui=NONE cterm=NONE
hi PmenuMatch guifg=#ffaf00 guibg=NONE gui=NONE cterm=NONE
hi PmenuKind guifg=#827700
