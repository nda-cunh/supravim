...
g:colors_name = "tokyostorm"

hi SpecialKey guifg=#3a405e guibg=NONE guisp=NONE gui=NONE ctermfg=237 ctermbg=NONE cterm=NONE
hi EndOfBuffer guifg=#24283b guibg=#24283b guisp=NONE gui=NONE ctermfg=235 ctermbg=235 cterm=NONE
hi NonText guifg=#3a405e guibg=NONE guisp=NONE gui=NONE ctermfg=237 ctermbg=NONE cterm=NONE
...
hi IncSearch guifg=#24283b guibg=#ff7a93 guisp=NONE gui=NONE ctermfg=235 ctermbg=203 cterm=NONE
hi Search guifg=#24283b guibg=#b9f27c guisp=NONE gui=NONE ctermfg=235 ctermbg=107 cterm=NONE
...
hi CursorLineNr guifg=#a9b1d6 guibg=#282d42 guisp=NONE gui=NONE ctermfg=250 ctermbg=236 cterm=NONE
hi Question guifg=#E0AF68 guibg=NONE guisp=NONE gui=NONE ctermfg=179 ctermbg=NONE cterm=NONE
hi StatusLine guifg=#a9b1d6 guibg=#333954 guisp=NONE gui=NONE ctermfg=250 ctermbg=237 cterm=NONE
hi StatusLineNC guifg=#444B6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE
...
hi Visual guifg=NONE guibg=#333954 guisp=NONE gui=NONE ctermfg=NONE ctermbg=237 cterm=NONE
hi VisualNOS guifg=NONE guibg=#333954 guisp=NONE gui=NONE ctermfg=NONE ctermbg=237 cterm=NONE
hi WarningMsg guifg=#E0AF68 guibg=NONE guisp=NONE gui=NONE ctermfg=179 ctermbg=NONE cterm=NONE
hi WildMenu guifg=#24283b guibg=#b9f27c guisp=NONE gui=NONE ctermfg=235 ctermbg=107 cterm=NONE
hi Folded guifg=#444B6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE
hi FoldColumn guifg=#444B6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE
...
hi SignColumn guifg=#a9b1d6 guibg=#282d42 guisp=NONE gui=NONE ctermfg=250 ctermbg=236 cterm=NONE
...
hi Pmenu guifg=#a9b1d6 guibg=#2f344d guisp=NONE gui=NONE ctermfg=250 ctermbg=236 cterm=NONE
hi PmenuSel guifg=#24283b guibg=#b9f27c guisp=NONE gui=NONE ctermfg=235 ctermbg=107 cterm=NONE
...
hi PmenuSbar guifg=NONE guibg=#2f344d guisp=NONE gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE
...
hi TabLine guifg=#a9b1d6 guibg=#3a405e guisp=NONE gui=NONE ctermfg=250 ctermbg=237 cterm=NONE
hi TabLineSel guifg=#24283b guibg=#ff7a93 guisp=NONE gui=NONE ctermfg=235 ctermbg=203 cterm=NONE
hi TabLineFill guifg=#444B6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE
hi CursorColumn guifg=NONE guibg=#282d42 guisp=NONE gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE
hi CursorLine guifg=NONE guibg=#282d42 guisp=NONE gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE
hi ColorColumn guifg=NONE guibg=#282d42 guisp=NONE gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE
hi QuickFixLine guifg=#7AA2F7 guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
hi StatusLineTerm guifg=#a9b1d6 guibg=#333954 guisp=NONE gui=NONE ctermfg=250 ctermbg=237 cterm=NONE
hi StatusLineTermNC guifg=#444B6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE
hi Normal guifg=#a9b1d6 guibg=#24283b guisp=NONE gui=NONE ctermfg=250 ctermbg=235 cterm=NONE
hi MatchParen guifg=NONE guibg=#3a405e guisp=NONE gui=NONE ctermfg=NONE ctermbg=237 cterm=NONE
hi ToolbarLine guifg=#a9b1d6 guibg=#2f344d guisp=NONE gui=NONE ctermfg=250 ctermbg=236 cterm=NONE
hi ToolbarButton guifg=#24283b guibg=#7da6ff guisp=NONE gui=NONE ctermfg=235 ctermbg=110 cterm=NONE
hi Terminal guifg=#a9b1d6 guibg=#24283b guisp=NONE gui=NONE ctermfg=250 ctermbg=235 cterm=NONE
hi Cursor guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Whitespace guifg=#3a405e guibg=NONE guisp=NONE gui=NONE ctermfg=237 ctermbg=NONE cterm=NONE
hi Debug guifg=#E0AF68 guibg=NONE guisp=NONE gui=NONE ctermfg=179 ctermbg=NONE cterm=NONE
hi debugPC guifg=#24283b guibg=#9ECE6A guisp=NONE gui=NONE ctermfg=235 ctermbg=107 cterm=NONE
hi debugBreakpoint guifg=#24283b guibg=#F7768E guisp=NONE gui=NONE ctermfg=235 ctermbg=203 cterm=NONE
...
hi CocHighlightText guifg=NONE guibg=#282d42 guisp=NONE gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE
hi ALEErrorSign guifg=#F7768E guibg=#282d42 guisp=NONE gui=NONE ctermfg=203 ctermbg=236 cterm=NONE
...
hi CocErrorFloat guifg=#F7768E guibg=#2f344d guisp=NONE gui=NONE ctermfg=203 ctermbg=236 cterm=NONE
hi CocWarningFloat guifg=#E0AF68 guibg=#2f344d guisp=NONE gui=NONE ctermfg=179 ctermbg=236 cterm=NONE
hi CocInfoFloat guifg=#7AA2F7 guibg=#2f344d guisp=NONE gui=NONE ctermfg=110 ctermbg=236 cterm=NONE
hi CocHintFloat guifg=#9ECE6A guibg=#2f344d guisp=NONE gui=NONE ctermfg=107 ctermbg=236 cterm=NONE
hi ALEWarningSign guifg=#E0AF68 guibg=#282d42 guisp=NONE gui=NONE ctermfg=179 ctermbg=236 cterm=NONE
hi ALEInfoSign guifg=#7AA2F7 guibg=#282d42 guisp=NONE gui=NONE ctermfg=110 ctermbg=236 cterm=NONE
...
hi GitGutterAdd guifg=#9ECE6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=107 ctermbg=236 cterm=NONE
hi GitGutterChangeDelete guifg=#ad8ee6 guibg=#282d42 guisp=NONE gui=NONE ctermfg=176 ctermbg=236 cterm=NONE
hi GitGutterChange guifg=#7AA2F7 guibg=#282d42 guisp=NONE gui=NONE ctermfg=110 ctermbg=236 cterm=NONE
hi GitGutterDelete guifg=#F7768E guibg=#282d42 guisp=NONE gui=NONE ctermfg=203 ctermbg=236 cterm=NONE
...
hi deniteInput guifg=#9ECE6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=107 ctermbg=236 cterm=NONE
hi deniteStatusLineNumber guifg=#ad8ee6 guibg=#282d42 guisp=NONE gui=NONE ctermfg=176 ctermbg=236 cterm=NONE
hi deniteStatusLinePath guifg=#a9b1d6 guibg=#282d42 guisp=NONE gui=NONE ctermfg=250 ctermbg=236 cterm=NONE
...
hi CtrlPMode1 guifg=#7AA2F7 guibg=#282d42 guisp=NONE gui=NONE ctermfg=110 ctermbg=236 cterm=NONE
hi CtrlPMode2 guifg=#282d42 guibg=#7AA2F7 guisp=NONE gui=NONE ctermfg=236 ctermbg=110 cterm=NONE
hi CtrlPStats guifg=#444B6A guibg=#282d42 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE
...
hi SignatureMarkText guifg=#7AA2F7 guibg=#282d42 guisp=NONE gui=NONE ctermfg=110 ctermbg=236 cterm=NONE
hi SignatureMarkerText guifg=#F7768E guibg=#282d42 guisp=NONE gui=NONE ctermfg=203 ctermbg=236 cterm=NONE
